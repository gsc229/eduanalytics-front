...
export default function SearchInput({}) {
  ...
  const school_fields =
    "id,school.name,school.alias,school.city,school.state,school.zip,school.school_url,latest.student.size,";
  const latest_fields =
  ...
  return (
    <Fragment>
      ...
      {!onSearchPage && (
        <Button onClick={handleBackToSearch} className={classes.backButon}>
